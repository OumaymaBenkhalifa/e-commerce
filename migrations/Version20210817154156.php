 ...
 */
final class Version20210817154156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP panier_id, CHANGE roles roles JSON NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE paiement_id paiement_id INT DEFAULT NULL, CHANGE panier_id panier_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE estimated_delivery_time estimated_delivery_time DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE paiement CHANGE users_id users_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD panier_id INT NOT NULL, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E9F77D927C FOREIGN KEY (panier_id) REFERENCES panier (id)');
